...
<em class="text-xl">NOTE: These credentials are <b>ONLY</b> used to get transcript and timetable information</em>
<form action="/inc/dashboard.php" method="POST" enctype="multipart/form-data">
    <input type="hidden" name="form_title" value="upload_timetable">
